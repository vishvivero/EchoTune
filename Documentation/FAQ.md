...
- Single device: $34.99
- 3-device pack: $79.99
- 5-device pack: $119.99
- 10-device pack: $199.99
- Includes referral rewards

### Is there a free trial?

**Yes!** 7-day free trial with full access to all features. No credit card required.
...
**App Store version:** One license = one Mac (Apple enforces this)

**Direct purchase:**
- Single device: 1 Mac
- 3-device pack: 3 Macs
- 5-device pack: 5 Macs
- 10-device pack: 10 Macs

You can deactivate on one Mac and activate on another within your license limits.
...
**No.** We don't use analytics, tracking, or telemetry.

Statistics (word count, session count) are stored locally on your Mac only.
...
1. Check macOS version (needs 13.0+)
2. Restart Mac
